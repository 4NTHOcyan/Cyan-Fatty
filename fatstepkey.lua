...
Junkie.service = "fatstep"
Junkie.identifier = "1034764"
Junkie.provider = "fatstepProv"
...
local result = (function()
    ...
    if result and result.valid then
        if result.message == "KEYLESS" then
            ...
            if ui.close then 
                ui:close()
                loadstring(game:HttpGet("https://raw.githubusercontent.com/0xfort77/cyhub-f/refs/heads/main/fatstepmain.lua"))() 
            end
            return
        end
